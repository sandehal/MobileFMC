...
const FMCScreen = ({ navigation, serverIp, sendJson, connected }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {<FMCKeyboard sendJson={sendJson} isExecLightOn={isExecLightOn} setIsExecLightOn={setIsExecLightOn} serverIp={serverIp}/>}
    </SafeAreaView>
  );
};
